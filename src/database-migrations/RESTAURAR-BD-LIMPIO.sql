-- ============================================
-- RESTAURACIÓN LIMPIA DE BASE DE DATOS
-- Sistema DUAR - Dirección de Bomberos
-- ============================================
-- Este script ELIMINA y RECREA las tablas de catálogo
-- NO afecta tus incidentes existentes
-- ============================================

-- ============================================
-- PASO 0: ELIMINAR VISTAS QUE DEPENDEN DE LAS TABLAS
-- ============================================
...
-- ============================================
-- PASO 0.5: ELIMINAR CONSTRAINTS DE INCIDENTES
-- ============================================
...
-- ============================================
-- PASO 0.7: ELIMINAR COLUMNAS DE INCIDENTES
-- ============================================
...
-- ============================================
-- PASO 1: ELIMINAR Y RECREAR TABLAS DE CATÁLOGO
-- ============================================

-- Eliminar tablas existentes (CASCADE elimina dependencias)
...
BEGIN
  ...
  RAISE NOTICE 'Incidentes existentes: % registros', v_incidentes;
  RAISE NOTICE '====================================';
  
  IF v_estados = 0 OR v_prioridades = 0 OR v_categorias = 0 THEN
    RAISE WARNING '⚠️ ERROR: Algunas tablas están vacías';
  ELSE
    RAISE NOTICE '🎉 TODO CORRECTO - Recarga la aplicación';
  END IF;
END $$;

SELECT 
  '🎉 BASE DE DATOS RESTAURADA' as status,
  'Ahora recarga la aplicación (F5)' as next_step;
