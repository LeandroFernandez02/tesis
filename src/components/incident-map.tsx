...
export function IncidentMap({ incidents, teams = [], onIncidentSelect, selectedIncident, className, centerOnIncident = false }: IncidentMapProps) {
            ...
            {!mapLoaded && (
              <div className="absolute inset-0 bg-muted rounded-lg flex items-center justify-center z-10">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Cargando mapa de OpenStreetMap...</p>
                </div>
              </div>
            )}
          </div>
